...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool >::type calculate_hessian(calculate_hessianSEXP);
    Rcpp::traits::input_parameter< const bool >::type unconstrained(unconstrainedSEXP);
    __result = Rcpp::wrap(GetCustomElboDerivatives(r_x, r_y, r_y_g, r_vp, r_pp, include_obs, include_hier, include_prior, include_entropy, global_only, calculate_gradient, calculate_hessian, unconstrained));
    return __result;
END_RCPP
}
// GetMoments
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Rcpp::List >::type r_pp(r_ppSEXP);
    Rcpp::traits::input_parameter< bool >::type unconstrained(unconstrainedSEXP);
    __result = Rcpp::wrap(GetSparseELBOHessian(r_x, r_y, r_y_g, r_vp, r_pp, unconstrained));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(GetLogVariationalDensityDerivatives(r_obs_mp, r_vp, r_pp, include_mu, include_lambda, r_include_mu_groups, r_include_tau_groups, calculate_gradient));
    return __result;
END_RCPP
}
